...
<body>
    ...
    <p>This privacy policy applies to the Bitaqty - بطاقتي app (hereby referred to as "Application") for mobile devices
        that was created by Seif AbuAshour (hereby referred to as "Service Provider") as a Free service. This service is
    ...
    <p>For a better experience, while using the Application, the Service Provider may require you to provide us with
        certain personally identifiable information, including but not limited to Email, Profile Picture, Full Name,
        Country, City. The information that the Service Provider request will be retained by them and used as described
    ...
    <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable
        ...
        please contact them at support@bitaqty.com and they will respond in a reasonable time.</p>
    ...
    <div><br>
        <p>The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect
            ...
            provided us with personal information, please contact the Service Provider (support@bitaqty.com) so that
    ...
    <p>This privacy policy is effective as of 2024-03-16</p><br><strong>Your Consent</strong>
    ...
    <p>If you have any questions regarding privacy while using the Application, or have questions about the practices,
        please contact the Service Provider via email at support@bitaqty.com.</p>
    <hr>
