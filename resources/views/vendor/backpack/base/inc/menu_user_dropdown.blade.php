<li class="nav-item dropdown pr-4">
    ...
    <div
        ...
        @if (\App\Models\Maintenance::first()->is_active)
            <a class="dropdown-item" href="{{ backpack_url('maintenance/off') }}"><i class="la la-play"></i>
                {{ __('sidebar.maintenances') }}</a>
        @else
            <a class="dropdown-item" href="{{ backpack_url('maintenance/on') }}"><i class="la la-power-off"></i>
                {{ __('sidebar.maintenances') }}</a>
        @endif
        <div class="dropdown-divider"></div>
